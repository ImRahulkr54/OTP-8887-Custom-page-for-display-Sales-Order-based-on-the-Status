 ...
 * 
 * Description : This script is defined to custom form that will display sales orders which need to be fulfilled or billed. The form consists of a Sublist with several columns and filters such as
 *               Status, Subsidiary, Customer & Department. Data displayed in the Sublist should be update dynamically based on these filters.
 * 
 * REVISION HISTORY
 * 
